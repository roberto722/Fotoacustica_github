...
results = run_lambda_sweep_residuals(params, model, reg_methods, lambdas, 'PRIN_DATI');
...
function params = build_params()
    ...
    % Naming canonico + alias legacy per compatibilita'.
    params.voc_ids = ["PAtestKMM2"];
    ...
    params.field_of_view = [-0.01905 0.01905 0 0.026];
    params.number_of_grid_points_fov = [512 512];
