...
for i = 1:numel(lambdas)
    ...
    if any(strcmp(lambdas(i) , ["1e-5", "1e-4", "1e-3"]))
        enable_metrics = true;
    else
    ...
    % Reconstruction
    [recs, references, lCurveErrImg, lCurveErrReg] = reconstruct_from_VOC_residuals('VOC2012', model_linear, params, reg_methods, false);
    if enable_metrics
