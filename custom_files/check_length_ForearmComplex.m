function file = check_length_ForearmComplex(file, model)
    ...
    elseif size(file, 1) > model.Probe.DAC.numRecordedSamplesPerTransducer && size(file, 1) < (model.Probe.DAC.numRecordedSamplesPerTransducer + 200)
