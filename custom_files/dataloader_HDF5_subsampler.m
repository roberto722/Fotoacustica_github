function [sinograms, file_names] = dataloader_HDF5_subsampler(ids, model)
...
for i = 1:numel(ids)
    for w = 1:numel(wavelengths)
        ...
        checked_signal = check_length_HDF5_subsampler(raw_signal, model);
        checked_signal = subSampler(checked_signal);
