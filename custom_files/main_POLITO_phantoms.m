...
%% Define model
params.mat_filenames = {"US_base_long"};
params.folder = 'E:\Scardigno\Fotoacustica-MB\data\fantocci_PDMS_Y_20250422'; % 20250324_PDMS_agarosio';
params.device_probe_id = 'PoliTo_probe_phantoms'; % see Probe.m for all available probes
params.max_imgs = 1;
params.ForearmComplex_ids = {}; %["2009_004734.jpg" "2007_002216.jpg" "2007_000123.jpg" "2007_001761.jpg" "2007_002953.jpg" "2007_003104.jpg" "2007_003367.jpg" "2007_004510.jpg" "2007_005360.jpg"];
...
params.filt_cutoff_min = 1;
params.filt_cutoff_max = 12e6;
params.field_of_view = [-0.01905 0.01905 0 0.025]; %[-0.01905 0.01905 0 0.020]; % [x_fov_min x_fov_max z_fov_min z_fov_max]
params.number_of_grid_points_fov = [668 429]; %[853 444]; %[635 333];            % [grid_points_x_dimension grid_points_z_dimension]
params.speed_of_sound_tissue = 1250; %1540  %1200;
