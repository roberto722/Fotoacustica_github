...
%% Define model
params.device_probe_id = 'PoliTo_probe_saturazione_ossigeno'; %'PoliTo_probe'; % see Probe.m for all available probes
params.max_imgs = 100;
params.VOC_id_imgs = {}; %{"2007_003051.jpg"}; %["2009_004734.jpg" "2007_002216.jpg" "2007_000123.jpg" "2007_001761.jpg" "2007_002953.jpg" "2007_003104.jpg" "2007_003367.jpg" "2007_004510.jpg" "2007_005360.jpg"];
params.mb_batch = 1;
...
params.field_of_view = [-0.01905 0.01905 0 0.038]; % [-0.01905 0.01905 -0.0192 0.0192]; % [x_fov_min x_fov_max z_fov_min z_fov_max]
...
reconstruct_from_VOC('VOC2012', model, params);

%reconstruct_from_CIRCLE(model, params, [256 256], 3);
% 
% center_pos = [64 64;  128 64;  192 64;
%               64 128; 128 128; 192 128;
%               64 192; 128 192; 192 192];
% reconstruct_from_GRID(model, params, center_pos, 10);
