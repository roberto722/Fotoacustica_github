...
%% Define model
params.device_probe_id = 'PoliTo_probe_Y_shaped'; % see Probe.m for all available probes
params.max_imgs = 1;
...
params.filt_cutoff_max = 6e7;
params.field_of_view = [-0.02 0.02 0 0.0162]; %[-0.01905 0.01905 0 0.020]; % [x_fov_min x_fov_max z_fov_min z_fov_max]
params.number_of_grid_points_fov = [640 267]; %[853 444]; %[635 333];            % [grid_points_x_dimension grid_points_z_dimension]
params.speed_of_sound_tissue = 1500; %1540  %1200;
